...
The Life::Mathematics distrubution provides a simple `add-up` subroutine that encapsulates the logic as described in: [Mathematics of Life](https://kennysloop.substack.com/p/mathematics-of-life)
